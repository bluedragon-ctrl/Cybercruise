...
const CAR_FIELD_DESCRIPTIONS = {
  ...
  hardFloor: "HARD FLOOR, world units/sec: nothing may drive this car slower — not its tactic, not braking behind another car, not slowing to fit a swerve past a roadblock. 0 means it can be brought to a full stop. Raise it and the car cannot hold station behind a player who slows down; lower it and slowing down does not shake it.",
  ...
  passEffort: "Multiplier on this driver's cruising speed while it is committed to a pass. CAPPED at the car's own speedMax, so it does nothing for a type already cruising at its ceiling — check the Speed group before tuning it.",
  ...
  chaseSpeed: "The chase ceiling in world units/sec — an ABSOLUTE speed, not a multiple of anything. Deliberately allowed above the car's own speedMax: the speed band governs ordinary cruise, this is what the car spends once the player is worth chasing. Set it under speedMax and this type never chases at full pace.",
