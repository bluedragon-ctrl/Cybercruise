...
const CAR_FIELD_DESCRIPTIONS = {
  ...
  leadHold: "How far AHEAD of the player (world units) this driver holds station — the tactics that attack from in front. Read by the outrunner, the siege mortar, the bunker trailer and the gunship. Bounded at both ends: under the gun's minimum it is inside contact range, and past the road the player can see it is a hostile posing off the top of the screen.",
